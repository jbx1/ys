...
public class UserService {
    ...
    public UserService(UserRepository userRepository, AccreditationRepository accreditationRepository) {
    ...
    public List<Accreditation> getUserAccreditations(String userId) {
        ...
        List<Accreditation> accreditations = accreditationRepository.findByUserUserId(userId);
