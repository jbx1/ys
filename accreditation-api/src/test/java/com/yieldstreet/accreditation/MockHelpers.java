...
public class MockHelpers {
    ...
    public static List<Accreditation> mockAccreditations(String userId, int count) {
        return Stream.generate(() -> mockAccreditation(mockUser(userId)))
                .limit(count)
                .collect(Collectors.toList());
    }

    public static Accreditation mockAccreditation(User user) {
        ...
        accreditation.setStatus(randomEnum(Accreditation.AccreditationStatus.class));
